#-----------------------------------------------------
# Magic/TCL design kit for GF gf180mcuC
#-----------------------------------------------------
# Tim Edwards
...
if {[catch {set TECHPATH $env(PDK_ROOT)}]} {
    set TECHPATH /home/donn/.volare/volare/gf180mcu/build/e0f692f46654d6c7c99fc70a0c94a080dab53571
}
if [catch {set PDKPATH}] {set PDKPATH ${TECHPATH}/gf180mcuC}
set PDKNAME gf180mcuC
# "gf180mcu" is the namespace used for all devices
set PDKNAMESPACE gf180mcu
puts stdout "Loading gf180mcuC Device Generator Menu ..."
