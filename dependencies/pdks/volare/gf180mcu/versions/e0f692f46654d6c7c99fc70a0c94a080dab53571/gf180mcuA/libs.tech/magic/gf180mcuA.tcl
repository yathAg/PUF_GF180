#-----------------------------------------------------
# Magic/TCL design kit for GF gf180mcuA
#-----------------------------------------------------
# Tim Edwards
...
if [catch {set PDKPATH}] {set PDKPATH ${TECHPATH}/gf180mcuA}
set PDKNAME gf180mcuA
# "gf180mcu" is the namespace used for all devices
set PDKNAMESPACE gf180mcu
puts stdout "Loading gf180mcuA Device Generator Menu ..."
