#-----------------------------------------------------
# Magic/TCL design kit for GF gf180mcuB
#-----------------------------------------------------
# Tim Edwards
...
if [catch {set PDKPATH}] {set PDKPATH ${TECHPATH}/gf180mcuB}
set PDKNAME gf180mcuB
# "gf180mcu" is the namespace used for all devices
set PDKNAMESPACE gf180mcu
puts stdout "Loading gf180mcuB Device Generator Menu ..."
